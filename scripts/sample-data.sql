...
INSERT INTO `Users` (`role`, `user_id`, `username`, `password`, `association`) VALUES
  ('MANAGER', 'admin', 'Dr. Manager', '$argon2i$v=19$m=4096,t=3,p=1$Y29tLmV4YW1wbGUuZGVsaXZlcnkx$Ou4CFuht9i47AR8hdKKui4b64Oe3+kc0/bhxfD++W40', NULL),
  ('DRIVER', 'foo', 'B. Foo', '$argon2i$v=19$m=4096,t=3,p=1$Y29tLmV4YW1wbGUuZGVsaXZlcnkx$XR42PlYSYy/FCkmG2cmX+MxJWgd8u08WQuQqLsY1jSw', NULL),
  ('DRIVER', 'carol', 'Carol', '$argon2i$v=19$m=4096,t=3,p=1$Y29tLmV4YW1wbGUuZGVsaXZlcnkx$hVJAq8p6/ejoOe/paRHRcmkYHrKInqVrDVy9ZD++CfU', NULL),
  ('SS_ADMIN', 'alice', 'Alice', '$argon2i$v=19$m=4096,t=3,p=1$Y29tLmV4YW1wbGUuZGVsaXZlcnkx$xjr/dc3DBcUORkrUSYr5NNEZ7/DKvPnQVWYlGm4djXY', (SELECT id FROM `Sites` WHERE `name` = 'Example Supplier Site 1')),
  ('BS_ADMIN', 'bob', 'Bob', '$argon2i$v=19$m=4096,t=3,p=1$Y29tLmV4YW1wbGUuZGVsaXZlcnkx$qUAHQzLQVOy1yc+cHfzC2pdAI6wpwU5vFp6gu23xcXM', (SELECT id FROM `Sites` WHERE `name` = 'Example Building Site 1'));
