...
class ListAdapterBuildingsites : RecyclerView.Adapter<ListAdapterBuildingsites.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.delivery_to__text_list).setTextColor(Color.BLUE)
    }
